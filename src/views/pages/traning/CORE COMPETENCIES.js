		...
		<>
			<section className='video-banner'>
				<video src="https://www.w3schools.com/howto/rain.mp4"
					muted autoPlay={"autoplay"} poster="" loop>video tag is not supported by your browser</video>
						...
						<div className='col-10'>
							<div className='row'>
								<div className='col-lg-5'>
									<div className='image-list'>
										<img src='/images/home-fms-main.jpg' alt='img' className='img-fluid' />
										<div className='icon-bx'>
											<img src='/images/foreign-military-icon.png' alt='img' className='img-fluid' />
										</div>
									</div>
								</div>
								<div className='col-lg-7'>
									<div className='content-bx'>
										...
										<div className='btn-bottom'>
											<a href='#'>FMS Document <img src='/images/pdf-icon.png' alt='img' width={100} /></a>
										</div>
									</div>
								</div>
							</div>
								...
								<OwlCarousel {...options}>
									<div className='item'>
										<div className='core-bx'>
											...
											<a href='#'>
												Subject Matter <br />Expertise
											</a>
										</div>
									</div>
									<div className='item'>
										<div className='core-bx'>
											<img src='/images/services-slide-2.jpeg' alt='img' className='img-fluid' />
											<a href='#'>
									...
									<div className='item'>
										<div className='core-bx'>
											<img src='/images/services-slide-3.jpeg' alt='img' className='img-fluid' />
											<a href='#'>
												Cybersecurity
											</a>
										</div>
									...
									<div className='item'>
										<div className='core-bx'>
											<img src='/images/services-slide-4.jpeg' alt='img' className='img-fluid' />
											<a href='#'>
									...
									<div className='item'>
										<div className='core-bx'>
											<img src='/images/services-slide-5.jpeg' alt='img' className='img-fluid' />
											<a href='#'>
												Electronic Classroom<br />Set-up
											</a>
										</div>
									</div>
								</OwlCarousel>
					...
					<div className='row'>
						<div className='col-md-12'>
							<div className='bg-e6e6e5 p-2 mb-5'>
								<div className='row justify-content-end'>
									<div className='col-md-9'>
										<h2 className='mt-5'>Minimize Logistical Challenges & Maximize Benefits</h2>
										<ul>
											<li>Reliability, Accountability, Maintainability (RAM)</li>
										...
										<div className='text-center'>
											<a href='#' className='btn btn-outline mb-5'>EXPLORE LOGISTICS CAPABILITIES</a>
										</div>
									</div>
								</div>
							</div>
							...
							<div className='bg-363636 glo-foreign p-2'>
								<div className='row justify-content-end'>
									<div className='col-md-9'>
										<h2 className='mt-5 text-white'>Globalize With Foreign Military Sales </h2>
										<p className='text-white'>
											Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet<br className='d-none d-lg-block' /> dolore magna aliquam erat volutpat.
										</p>
										<div className='glo-icons'>
											<ul>
												<li>
													<img src='/images/air-icon.png' alt='Air' className='img-fluid' />
													<span>Air</span>
												</li>
												<li>
													<img src='/images/land-icon.png' alt='Air' className='img-fluid' />
													<span>Land</span>
												</li>
												<li>
													<img src='/images/sea-icon.png' alt='Air' className='img-fluid' />
													<span>Sea</span>
												</li>
												<li>
													<img src='/images/space-icon.png' alt='Air' className='img-fluid' />
													<span>Space</span>
												</li>
												<li>
													<img src='/images/cyber-icon.png' alt='Air' className='img-fluid' />
													<span>Cyber</span>
												</li>
												<li>
													<img src='/images/education-icon.png' alt='Air' className='img-fluid' />
													<span>Education</span>
												</li>
											</ul>
										</div>
										<div className='text-center'>
											<a href='#' className='btn btn-outline mb-5'>DISCOVER FMS OPPORTUNITES</a>
										</div>
									</div>
								</div>
							</div>
			...
			<section className='contract-vehicles' id='contract-vehicles'>
				<div className='container'>
						...
						<div className='row'>
							<div className='col-lg-6 footer-bx'>
								<div className='image-bx'>
									{/* <img src="/images/dummy.png" className='img-fluid' /> */}
								</div>
							</div>
							<div className='col-lg-6 footer-bx'>
								<h2>DEMONSTRATED EXPERIENCE </h2>
								<p>
									Our success is based on client satisfaction. Not only do we boast of our organizational past performance, but we also ensure all team members and teaming partners meet our standards of quality service; on-time deliverables; and effective, efficient, and superior performance.
								</p>
								...
								<div className='partner-ship'>
									...
									<ul>
										<li className='logos-item'>
											<img src="/images/partner-logo-1.png" className='img-fluid' />
										</li>
										<li className='logos-item'>
											<img src="/images/partner-logo-2.png" className='img-fluid' />
										</li>
										<li className='logos-item'>
											<img src="/images/partner-logo-3.png" className='img-fluid' />
										</li>
										<li className='logos-item'>
											<img src="/images/partner-logo-4.png" className='img-fluid' />
										</li>
										<li className='logos-item'>
											<img src="/images/partner-logo-5.png" className='img-fluid' />
										</li>
									</ul>
								</div>
							</div>
